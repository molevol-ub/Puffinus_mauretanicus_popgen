...
vcftools --gzvcf all_inds.ann.vcf.gz --positions polarise_positions.bed --recode --out included
...
vcftools --gzvcf all_inds.ann.vcf.gz --exclude-positions polarise_positions.bed --recode --out excluded
