The 3 **numbered** scripts in this file are to be run after **both** the 9 scripts from the main *genome _scans* directory and the 2 scripts from the GC_gene directory have been executed.
