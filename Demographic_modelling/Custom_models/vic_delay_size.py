...
def vic_delay_size(params, ns, pts):
    """
    s, nu1, nu2, Tpre, Tmig, m12, m21 = params
    
    Split into two vicariant populations, with asymmetrical migration after some time has passed post split. The onset of migration is accompanied by a population size change.
...
vic_delay_size.__param_names__ = ["s", "nu1", "nu2", "Tpre", "Tmig", "m12", "m21"]
